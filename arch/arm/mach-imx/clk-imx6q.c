...
int __init mx6q_clocks_init(void)
{
	...
	clk_register_clkdev(clk[gpu2d_core], "gpu2d_clk", "130000.galcore");
	clk_register_clkdev(clk[gpu3d_core], "gpu3d_clk", "130000.galcore");
	clk_register_clkdev(clk[gpu3d_shader], "gpu3d_shader_clk", "130000.galcore");
