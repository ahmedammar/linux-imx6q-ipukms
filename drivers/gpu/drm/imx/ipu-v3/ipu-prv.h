...
#define IPU_CPMEM_REG_BASE	(IPU_CM_REG_BASE + 0x00100000)
#define IPU_LUT_REG_BASE	(IPU_CM_REG_BASE + 0x01020000)
#define IPU_SRM_REG_BASE	(IPU_CM_REG_BASE + 0x00140000)
#define IPU_TPM_REG_BASE	(IPU_CM_REG_BASE + 0x00160000)
#define IPU_DC_TMPL_REG_BASE	(IPU_CM_REG_BASE + 0x00180000)
